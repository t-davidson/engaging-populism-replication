...
p
ggsave2(filename = "figures/figure5.pdf", width = 8.3, height = 9.7)
...
p2 <- rs.poppa.int %>% ggplot(aes(y = effect, x = year, ymin = .lower, ymax = .upper)) +
    ...
    facet_wrap(. ~ country, ncol = 5, scales = "free_y")
p2
ggsave2(filename = "figures/figure5_poppa.pdf", width = 8.3, height = 9.7)
...
p3 <- rs.gps.int %>% ggplot(aes(y = effect, x = year, ymin = .lower, ymax = .upper)) +
    ...
    facet_wrap(. ~ country, ncol = 5, scales = "free_y")
p3
ggsave2(filename = "figures/figure5_gps.pdf", width = 8.3, height = 9.7)
